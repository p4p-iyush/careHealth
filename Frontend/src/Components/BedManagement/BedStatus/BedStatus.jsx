...
const BedStatus = () => {
  ...
  const handleDischarge = async (id) => {
    try {
      ...
      console.log("Discharge Bill Response:", billResponse.data); // ✅ Check if bill is generated
      ...
      console.log("Discharge Response:", dischargeResponse.data); // ✅ Check if patient is removed
